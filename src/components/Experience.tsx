...
const entries = [
  ...
  },
  {
    ...
    role: "Research Participant — AI & ML",
    org: "SEAS Vietnam",
    detail: "Selected 43 / 400 · Vietnam",
    bullets: [
      "Completed MIT-adapted curriculum under mentors from Harvard, MIT, CERN, UIUC, VinAI",
      "Built predictive ML models for flood forecasting using time-series regression",
    ],
    icon: "🔬",
    stat: "43",
    statLabel: "of 400",
